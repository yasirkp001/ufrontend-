...
export const AuthProvider = ({ children }) => {
    ...
    const googleLogin = async (credential) => {
        try {
            ...
            console.error('Google login error context:', error.message);
            throw error;
        }
    };
    ...
    return (
        <AuthContext.Provider value={{ isAuthenticated, userEmail, user, loading, login, googleLogin, register, logout, refreshUser }}>
            {children}
